...
public class MarkdownPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public static final String PREF_MARKDOWN_TYPE = "Pref_Markdown_Type";

    private static final String GITHUB_FLAVORED = "github";
    ...
    public static void setDefaultPreferences(IPreferenceStore pStore) {
        ...
        pStore.setDefault(PREF_MARKDOWN_TYPE, GITHUB_FLAVORED);
    ...
    public void createFieldEditors() {
        ...
        StringFieldEditor tags = new StringFieldEditor(PREF_TASK_TAGS_DEFINED,
                                                       "Task tags\nComma separated list of recognised task tags.",
                                                       getFieldEditorParent());
        addField(tags);
        // Code folding
        fd = new BooleanFieldEditor(PREF_FOLDING, "Document folding, a.k.a. outline support", getFieldEditorParent());
        addField(fd);
        // Command line
        StringFieldEditor cmd = new StringFieldEditor(PREF_MARKDOWN_TYPE, "Type of Markdown.", getFieldEditorParent());
        addField(cmd);
        ...
        fd = new BooleanFieldEditor(PREF_GITHUB_SYNTAX, "Support Github Syntax", getFieldEditorParent());
        addField(fd);

        // Multi-Markdown support
        fd = new BooleanFieldEditor(PREF_MULTIMARKDOWN_METADATA, "Support Multi-Markdown Metadata", getFieldEditorParent());
        addField(fd);
    }
